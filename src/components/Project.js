            ...
            <Fade bottom>
                <div className={styles.swiper_wrap}>
                    ...
                    <div className={styles.project_content}>
                        ...
                        <br />
                        자바와 PHP, MySQL을 활용해 제작했고, 앱 내 결제는
                        부트페이를 연동했습니다. (테스트 결제로 실제 결제가
                        이뤄지지 않습니다.)
                        <br />
                        개발인원: 4명
                        <br />
                        사용자 페이지 주요 기능
                        <br />
                        회원가입, 로그인, 회원정보 수정, 글 작성 및 수정, 삭제,
                        밀키트로 제작할 레시피 투표, 밀키트 구매
                        <br />
                        관리자 페이지 주요 기능
                        <br />
                        로그인, 회원관리, 게시글 관리, 공지사항 작성 및 관리,
                        판매 관련 통계 데이터 시각화, 주문목록 확인
            ...
            <Fade bottom>
                <div className={styles.swiper_wrap}>
                    ...
                    <div className={styles.project_content}>
                        ...
                        <br />
                        우측 하단의 플로팅 버튼을 통해 시간을 설정할 수 있고,
                        설정된 시간이 계속 반복됩니다.
                        <br />
                        좌측 상단의 아이콘을 누르면 기본모드와 다크모드를 설정할
                        수 있습니다.
                        <br />
                        마지막 이미지는 데모버전으로, 웹에서의 모습입니다.
                        <br />
                        개발인원: 1명
                        <div className={styles.skill_shortcut}>
                            <div className={styles.skills}>
