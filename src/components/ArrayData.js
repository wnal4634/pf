...
const ProjectData = [
    ...
    },
    {
        ...
        detail_info:
            "모바일 사이즈의 경우, 우측 상단의 메뉴가 접힌 모습으로 변경됩니다. 변경된 메뉴는 상단바 우측의 아이콘을 통해 접고 펼 수 있습니다. 각 메뉴를 클릭하면 포트폴리오에서 해당하는 부분으로 쉽게 이동할 수 있습니다. 좌측의 아이콘은 화면 새로고침을 진행합니다. 이후로는 사용할 수 있는 기술들과 제작한 프로젝트들, 경험한 바를 작성했습니다.",
